...
public interface PdfNominaService {
    ...
    /**
     * Metodo para generar uinsertar una leyenda al pdf
     * @param rutaPdf
     * @param leyenda
     * @throws BusinessException
     */
    public void insertarLeyenda(String rutaPdf, String leyenda) throws BusinessException;
}
